...
| Period range picker & ongoing-period CTA — one range picker for period start + optional end (open end = "läuft noch") and a context-aware "Periode-Ende eintragen" CTA on Home + Zyklus-Historie | [spec](specs/spec-period-range-picker.md) | [#9](https://github.com/skrischer/flowmate/milestone/9) |
