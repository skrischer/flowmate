...
- Design: `docs/design.md` (Heather · Dark) — surfaces: Mate-View (phase-level, no raw data, no calendar; incl. revoked/empty state), Mate-Profil (follower identity, Abmelden, push on/off toggle)
