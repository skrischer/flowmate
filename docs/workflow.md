...
- GitHub repo: `skrischer/flowmate`
- Base / integration branch: `main`
- GitHub Project board: `https://github.com/users/skrischer/projects/8` (#8) —
...
- All implementation and docs work happens in a worktree — never in the main
  ...
  fast-forward pulls.
- Path convention: `../flowmate-worktrees/<branch-with-slashes-as-dashes>`.
...
> Greenfield note: there is no app code yet. The commands below are the
...
- QA-gate default check: UI check (smoke test on a simulator / device).
